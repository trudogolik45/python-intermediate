...
Проект учебный и одиночный: фича-ветки не заводим, коммиты идут сразу в `main`, без PR и код-ревью. Прогон проверок из «Commands» — единственные ворота перед коммитом.
